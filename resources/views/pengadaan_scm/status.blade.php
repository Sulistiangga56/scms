            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h3>Riwayat Pengadaan Barang/Jasa</h3>
                        <div class="d-flex ">
                            <form method="GET" action="{{ route('pengadaan_scm.status') }}" class="me-4">
                            ...
                            <form method="GET" action="{{ route('pengadaan_scm.index') }}">
                        ...
                        <tbody>
                            @foreach($pengadaanScm as $item)
                                <tr>
                                    ...
                                    <td><a href="{{ route('pengadaan_scm.detail', $item->id) }}" class="btn btn-info">Lihat</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
